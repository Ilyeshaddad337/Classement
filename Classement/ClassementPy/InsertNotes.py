...
Students =[]
#geting the file
with open("Data\\1cpiSections.csv", newline="\n") as f:
...
with open("ClassementPy\\Final_results.csv",'w', newline="\n") as f:
   ...
   spamwriter.writerow(['Sections','Groups','Full Name','Average','Algo','Analyse','Archi','Elec','Algebra','TEE','BW','Sys1'])
   for stud in Students:
      if len(stud)>=12:
